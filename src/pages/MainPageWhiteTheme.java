 ...
 * @author a_lpha
 */
public class MainPageWhiteTheme extends javax.swing.JFrame {
    ...
    public MainPageWhiteTheme(int idPengguna) {
        parent = this;
    ...
    public void dispose() {
        try {
            ...
            Logger.getLogger(MainPageWhiteTheme.class.getName()).log(Level.SEVERE, null, ex);
        }
        super.dispose();
    }
...
//        entriMejaPanel.revalidate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainPageWhiteTheme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
